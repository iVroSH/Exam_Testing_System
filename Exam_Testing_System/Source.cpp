...
int main() {
	...
	t.questions[0].insert_answer("4", 1);
	...
	t.questions[2].insert_answer("Да", 1);
	t.questions[2].insert_answer("Нет", 0);
	...
	map<int,Menu> qMenu, aMenu;
	map<int,vector<string>>QuestionsMenu, AnswersMenu;*/
